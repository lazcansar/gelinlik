...
Route::get('/sayfa', [PagesController::class, 'customerPageView'])->name('customer-page');
Route::get('/sayfa/{url}', [PagesController::class, 'customerPageDetail'])->name('customer-page-detail');
